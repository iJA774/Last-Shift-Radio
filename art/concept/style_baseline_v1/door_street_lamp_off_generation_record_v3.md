...
路灯灯罩与原有位置、比例和被夹丝玻璃遮挡关系保持一致，但不再有可见灯泡发光、暖色照明或暖色湿玻璃反射。单一中央夹丝玻璃、左右窄门框、雨滴、巷道透视和冷蓝黑雨夜纹理均保留；未见人物、怪物、文字、几何框、第二光源或额外雨线。该素材可作为亮灯版本的相邻切换帧。
